          ...
          <div className="mt-4 mb-4 flex flex-col items-center w-full">
            {game.title === "Flappy Bird" ? (
              <span className="text-gray-600 text-base text-center w-full">
                Flappy bird like game. Click mouse or Spacebar to jump. Built
                with Phaser JS.
              </span>
            ) : game.title === "Dinogame" ? (
              <span className="text-gray-600 text-base text-center w-full">
                To start the game press jump. Press space to jump. Press down to
                duck. Made with PhaserJs.
              </span>
            ) : game.title === "Boy With Stick" ? (
              <span className="text-gray-600 text-base text-center w-full">
                Use WASD or Arrow Keys to move around, click mouse to swing
                stick.
              </span>
            ) : (
              <span className="text-gray-600 text-base text-center w-full">
